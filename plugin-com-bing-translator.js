...
this['plugin-com-bing-translator'] = function (_, Kotlin, $module$kotlinx_html_js) {
  ...
  BingTranslationProvider.prototype.getQuickTranslation_0 = function (context, query) {
    return this.httpClient_0.post_bokjk9$('https://' + context.domain + '/ttranslatev3?isVertical=1&category=&IG=' + context.token + '&IID=translator.5038.1', mapOf(to('Content-Type', 'application/x-www-form-urlencoded')), this.buildFormData_0(getFrom(query), getTo(query), getText(query)));
  };
