(function (root, factory) {
  ...
  var andThen = defineInlineFunction('plugin-com-google-translate.org.dicthub.plugin.shared.util.andThen_g414bn$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
  ...
  var convert = defineInlineFunction('plugin-com-google-translate.org.dicthub.plugin.shared.util.convert_wus875$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var Promise_init = Promise;
  ...
  var allPromises = defineInlineFunction('plugin-com-google-translate.org.dicthub.plugin.shared.util.allPromises_m47hm4$', wrapFunction(function () {
  ...
  var allPromises_0 = defineInlineFunction('plugin-com-google-translate.org.dicthub.plugin.shared.util.allPromises_t4ctt0$', wrapFunction(function () {
    var Promise$Companion = Promise;
    var Any = Object;
    var throwCCE = Kotlin.throwCCE;
  ...
  GoogleTranslationParser.prototype.parse_w74nik$ = function (sourceUrl, jsonStr, from, to) {
    ...
    if ((tmp$_1 = getOrNull(firstLine, 0)) != null) {
      var tmp$_14;
      tmp$_13 = Kotlin.isArray(tmp$_14 = tmp$_1) ? tmp$_14 : null;
    }
     else
      tmp$_13 = null;
    tmp$_2 = tmp$_13;
    ...
    if ((tmp$_3 = getOrNull(firstLine, 1)) != null) {
      var tmp$_16;
      tmp$_15 = Kotlin.isArray(tmp$_16 = tmp$_3) ? tmp$_16 : null;
    }
     else
      tmp$_15 = null;
    var pron = tmp$_15;
    tmp$_5 = typeof (tmp$_4 = text[1]) === 'string' ? tmp$_4 : throwCCE();
    tmp$_7 = typeof (tmp$_6 = text[0]) === 'string' ? tmp$_6 : throwCCE();
    tmp$_9 = typeof (tmp$_8 = pron != null ? getOrNull(pron, 3) : null) === 'string' ? tmp$_8 : null;
    var tmp$_17;
    if ((tmp$_10 = getOrNull(json, 1)) != null) {
      var tmp$_18;
      tmp$_17 = Kotlin.isArray(tmp$_18 = tmp$_10) ? tmp$_18 : null;
    }
     else
      tmp$_17 = null;
    return new GoogleTranslation(sourceUrl, tmp$_5, from, to, tmp$_9, tmp$_7, (tmp$_12 = (tmp$_11 = tmp$_17) != null ? this.parseTranslationDetails_0(tmp$_11) : null) != null ? tmp$_12 : emptyList());
  };
  ...
  function GoogleTranslationProvider(httpClient, googleTranslationParser, googleTranslationRenderer) {
    ...
    this.tokenStorageKey_0 = 'plugin-googletranslation-token';
  }
  ...
  function GoogleTranslationProvider$translate$lambda$lambda(closure$query, this$GoogleTranslationProvider, closure$resolve) {
    return function (it) {
      return this$GoogleTranslationProvider.translateUsingNewToken_0(closure$query).then(closure$resolve);
    };
  }
  function GoogleTranslationProvider$translate$lambda(closure$query, this$GoogleTranslationProvider) {
    return function (resolve, f) {
      this$GoogleTranslationProvider.translateUsingCachedToken_0(closure$query).then(resolve).catch(GoogleTranslationProvider$translate$lambda$lambda(closure$query, this$GoogleTranslationProvider, resolve));
      return Unit;
    };
  }
  GoogleTranslationProvider.prototype.translate = function (query) {
    return new Promise(GoogleTranslationProvider$translate$lambda(query, this));
  };
  ...
  function GoogleTranslationProvider$translateUsingCachedToken$lambda$lambda$lambda(closure$resolve, this$GoogleTranslationProvider, closure$token) {
    return function (it) {
      closure$resolve(this$GoogleTranslationProvider.googleTranslationRenderer_0.render_900fok$(it, closure$token));
      return Unit;
    };
  }
  function GoogleTranslationProvider$translateUsingCachedToken$lambda(this$GoogleTranslationProvider, closure$query) {
    return function (resolve, reject) {
      var tmp$;
      var tmp$_0;
      if ((tmp$ = localStorage[this$GoogleTranslationProvider.tokenStorageKey_0]) != null) {
        var closure$query_0 = closure$query;
        var this$GoogleTranslationProvider_0 = this$GoogleTranslationProvider;
        console.info('Translate using cached google token ' + tmp$);
        tmp$_0 = this$GoogleTranslationProvider_0.translateWithToken_0(closure$query_0, tmp$).then(GoogleTranslationProvider$translateUsingCachedToken$lambda$lambda$lambda(resolve, this$GoogleTranslationProvider_0, tmp$)).catch(reject);
      }
       else
        tmp$_0 = null;
      if (tmp$_0 == null) {
        reject(IllegalStateException_init('No cached google token available'));
      }
      return Unit;
    };
  }
  GoogleTranslationProvider.prototype.translateUsingCachedToken_0 = function (query) {
    return new Promise(GoogleTranslationProvider$translateUsingCachedToken$lambda(this, query));
  };
  function GoogleTranslationProvider$translateUsingNewToken$lambda$lambda(this$GoogleTranslationProvider, closure$token) {
    return function (it) {
      return this$GoogleTranslationProvider.googleTranslationRenderer_0.render_900fok$(it, closure$token);
    };
  }
  function GoogleTranslationProvider$translateUsingNewToken$lambda$lambda_0(this$GoogleTranslationProvider, closure$query) {
    return function (it) {
  ...
  function GoogleTranslationProvider$translateUsingNewToken$lambda(this$GoogleTranslationProvider, closure$query) {
    return function (token) {
      console.info('Translate using new google token ' + token);
      localStorage[this$GoogleTranslationProvider.tokenStorageKey_0] = token;
      return this$GoogleTranslationProvider.translateWithToken_0(closure$query, token).then(GoogleTranslationProvider$translateUsingNewToken$lambda$lambda(this$GoogleTranslationProvider, token)).catch(GoogleTranslationProvider$translateUsingNewToken$lambda$lambda_0(this$GoogleTranslationProvider, closure$query));
    };
  }
  function GoogleTranslationProvider$translateUsingNewToken$lambda_0(this$GoogleTranslationProvider, closure$query) {
    return function (it) {
      return renderFailure(this$GoogleTranslationProvider.id(), this$GoogleTranslationProvider.sourceUrl_0(closure$query), closure$query, it);
    };
  }
  GoogleTranslationProvider.prototype.translateUsingNewToken_0 = function (query) {
    return this.getToken_0().then(GoogleTranslationProvider$translateUsingNewToken$lambda(this, query)).catch(GoogleTranslationProvider$translateUsingNewToken$lambda_0(this, query));
  };
